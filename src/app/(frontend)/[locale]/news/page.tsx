...
import { Calendar, Clock, ArrowRight, Shield, User, FileText } from 'lucide-react';
                ...
                <div className="p-6 space-y-3">
                  ...
                  <div className="pt-3 border-t border-gray-100 flex items-center justify-between gap-2">
                    ...
                    <span
                      ...
                      className="flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-accbcf-gold/15 text-accbcf-charcoal border border-accbcf-gold/40 flex-shrink-0"
                    >
